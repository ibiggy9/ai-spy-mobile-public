  ...
  useEffect(() => {
    ...
    return (
        <GlassContainer style={tw`flex-1 pt-15 px-5`}>
            ...
            >
                <View style={tw`px-6 py-3 rounded-full border ${isProMember ? 'border-green-400/40 bg-green-500/10' : 'border-orange-400/40 bg-orange-500/10'}`}>
                    <View style={tw`flex-row items-center gap-2`}>
                        <View style={tw`w-2 h-2 rounded-full ${isProMember ? 'bg-green-400' : 'bg-orange-400'}`} />
                        <Text style={tw`${isProMember ? 'text-green-300' : 'text-orange-300'} text-sm font-semibold tracking-wider`}>
            ...
            {/* <SandboxTestHelper /> */}
            <View style={tw`bg-yellow-500/10 border border-yellow-400/30 rounded-lg my-4`}>
