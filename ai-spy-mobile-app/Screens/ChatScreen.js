    ...
    <GlassContainer style={tw`flex-1`}>
      ...
      <View style={tw`flex-row items-center justify-between p-4 pt-12 border-b border-white/10`}>
        ...
        <View style={tw`flex-1 mx-4`}>
          <Text style={[tw`text-white font-semibold text-center`, { fontSize: 16 }]}>Chat with Ai-SPY</Text>
            ...
            <View style={tw`items-center justify-center flex-1 mt-8 p-4`}>
              <View style={tw`w-full mb-6`}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handlePresetClick("Give me an overview: What's the main finding and what key things did the model seem to focus on?")}
                >
                  <LinearGradient
                    colors={['rgba(100, 116, 139, 0.8)', 'rgba(71, 85, 105, 0.8)']}
                    style={tw`p-4 rounded-2xl border border-slate-600/50`}
                  >
                    <Text style={[tw`text-blue-400 font-medium mb-1`, { fontSize: 16 }]}>Overview</Text>
                    <Text style={[tw`text-slate-200`, { fontSize: 16 }]}>Give me an overview: What's the main finding and what key things did the model seem to focus on?</Text>
                  </LinearGradient>
                </TouchableOpacity>

                <TouchableOpacity
                  style={tw`mb-3`}
                  onPress={() => handlePresetClick("What did the model 'notice' in the audio segments that led to its human vs. AI predictions?")}
                >
                  <LinearGradient
                    colors={['rgba(100, 116, 139, 0.8)', 'rgba(71, 85, 105, 0.8)']}
                    style={tw`p-4 rounded-2xl border border-slate-600/50`}
                  >
                    <Text style={[tw`text-purple-400 font-medium mb-1`, { fontSize: 16 }]}>Model Insights</Text>
                    <Text style={[tw`text-slate-200`, { fontSize: 16 }]}>What did the model 'notice' in the audio segments that led to its human vs. AI predictions?</Text>
                  </LinearGradient>
                </TouchableOpacity>

                <TouchableOpacity
                  onPress={() => handlePresetClick("Highlight any particularly interesting or unusual segments in the analysis. Why do they stand out?")}
                >
                  <LinearGradient
                    colors={['rgba(100, 116, 139, 0.8)', 'rgba(71, 85, 105, 0.8)']}
                    style={tw`p-4 rounded-2xl border border-slate-600/50`}
                  >
                    <Text style={[tw`text-green-400 font-medium mb-1`, { fontSize: 16 }]}>Notable Segments</Text>
                    <Text style={[tw`text-slate-200`, { fontSize: 16 }]}>Highlight any particularly interesting or unusual segments in the analysis. Why do they stand out?</Text>
                  </LinearGradient>
                </TouchableOpacity>

                <TouchableOpacity
                  style={tw`mt-3`}
                  onPress={() => handlePresetClick("How does the spoken content (transcript) align with the model's predictions for different audio chunks?")}
                >
                  <LinearGradient
                    colors={['rgba(100, 116, 139, 0.8)', 'rgba(71, 85, 105, 0.8)']}
                    style={tw`p-4 rounded-2xl border border-slate-600/50`}
                  >
                    <Text style={[tw`text-orange-400 font-medium mb-1`, { fontSize: 16 }]}>Transcript Analysis</Text>
                    <Text style={[tw`text-slate-200`, { fontSize: 16 }]}>How does the spoken content (transcript) align with the model's predictions for different audio chunks?</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
          ...
          <View style={tw`mt-3`}>
            ...
            {isChatLoading && (
              <View style={tw`flex items-start w-full `}>
                <View style={tw`max-w-11/12 p-4 rounded-2xl py-6 bg-slate-700/80 border border-slate-600/50`}>
                  <View style={tw`flex-row items-center`}>
                    ...
                    <Text style={[tw`text-slate-300`, { fontSize: 16 }]}>Ai-SPY is thinking...</Text>
                  </View>
                </View>
              </View>
            )}
