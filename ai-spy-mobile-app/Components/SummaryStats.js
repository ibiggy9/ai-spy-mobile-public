...
export default function SummaryStats({ stats }) {
  ...
  else if (stats?.Total_AI !== undefined && stats?.Total_Human !== undefined && stats?.Total_Clips !== undefined) {
  ...
  overallConfidence = stats?.aggregate_confidence !== undefined ? 
    (() => {
    ...
    <GlassCard style={tw`mb-2 rounded-2xl`}>
      ...
      <View style={tw`flex-row items-center`}>
        ...
        <View style={tw`flex-1`}>
          <Text style={tw`text-base text-white mb-3`}>
            {overallAssessment}
          </Text>
