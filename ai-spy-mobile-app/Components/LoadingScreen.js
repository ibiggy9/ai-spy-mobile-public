  ...
  return (
    <Container style={tw`flex-1 bg-gray-900`}>
      <View style={tw`flex-1 justify-center items-center px-6`}>
        {/* Main Loading Card */}
        <View style={tw`w-full max-w-[380px] bg-white/10 border border-white/20 rounded-3xl p-8 mb-8`}>
          ...
          <View style={tw`items-center mb-8`}>
            ...
            <Text style={tw`text-[26px] font-bold text-white text-center mb-2`}>
              {title}
            </Text>
            
            <Text style={tw`text-[16px] text-white/60 text-center`}>
