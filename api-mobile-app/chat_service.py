...
class ChatService:
    def __init__(self):
        ...
        if not GENAI_AVAILABLE:
            ...
            self.model = None
            logger.warning("No Google AI API key found! Chat functionality will use fallback responses.")
    ...
    async def chat_with_gemini(
        ...
        try:
            ...
            if has_subscription and task_id and chat_usage_tracker:
                ...
                logger.info(f"Chat message {chat_usage_tracker[task_id]['chat_message_count']}/10 for task {task_id}")
            ...
            if analysis_results:
                ...
                if analysis_results.get('Results') and isinstance(analysis_results['Results'], dict):
                ...
                elif analysis_results.get('result') and isinstance(analysis_results['result'], dict):
                ...
                if chunk_results:
                    ...
                    embeddings_available = [chunk for chunk in chunk_results if chunk.get('embeddings')]
